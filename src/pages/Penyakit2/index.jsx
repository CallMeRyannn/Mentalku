import FrameComponent1 from "../../componentpenyakit2/FrameComponent1";
import FrameComponent2 from "../../componentpenyakit2/FrameComponent2";
import FrameComponent3 from "../../componentpenyakit2/FrameComponent3";
import FrameComponent4 from "../../componentpenyakit2/FrameComponent4";
import "./style.css";

const DirektoriPenyakit = () => {
  return (
    <div className="direktori-penyakit-2">
